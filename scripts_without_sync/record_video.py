...
def main():
    ...
    parser.add_argument('--outdir', '-o', default='recorded_videos', help='Output directory (relative to project root)')
    parser.add_argument('--fps', '-f', type=float, default=30.0, help='Output video FPS')
    parser.add_argument('--codec', '-c', default='mp4v', help='Video codec (mp4v, XVID, MJPG, etc.)')
    parser.add_argument('--resolution', '-r', nargs=2, type=int, metavar=('WIDTH', 'HEIGHT'), help='Force resolution')
    args = parser.parse_args()

    project_root = '/home/arrma/Computer_vision_in_navigation_of_unmanned_robotic_systems'
